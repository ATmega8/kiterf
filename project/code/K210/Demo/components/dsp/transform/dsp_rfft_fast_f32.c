 ...
 * \par Floating-point
 * The main functions are dsp_rfft_fast_f32() and dsp_rfft_fast_init_f32().
 * The older functions dsp_rfft_f32() and dsp_rfft_init_f32() have been
 ...
 * <pre>
 *dsp_rfft_instance_q31 S = {fftLenReal, fftLenBy2, ifftFlagR, bitReverseFlagR, twidCoefRModifier, pTwiddleAReal, pTwiddleBReal, pCfft};
 *dsp_rfft_instance_q15 S = {fftLenReal, fftLenBy2, ifftFlagR, bitReverseFlagR, twidCoefRModifier, pTwiddleAReal, pTwiddleBReal, pCfft};
 * </pre>
 ...
 * must also be initialized.  Refer to dsp_cfft_radix4_f32() for details regarding
...
* @param[in]  *S              points to an dsp_rfft_fast_instance_f32 structure.
...
void dsp_rfft_fast_f32(
    dsp_rfft_fast_instance_f32 *S,
    float32_t *p, float32_t *pOut,
    uint8_t ifftFlag)
{
    dsp_cfft_instance_f32 *Sint = &(S->Sint);
    ...
    if (ifftFlag) {
        ...
        dsp_cfft_f32(Sint, pOut, ifftFlag, 1);
    } else {
        /* Calculation of RFFT of input */
        dsp_cfft_f32(Sint, p, ifftFlag, 1);
