 ...
 * <pre>
 *dsp_fir_lattice_instance_f32 S = {numStages, pState, pCoeffs};
 *dsp_fir_lattice_instance_q31 S = {numStages, pState, pCoeffs};
 *dsp_fir_lattice_instance_q15 S = {numStages, pState, pCoeffs};
 * </pre>
 * \par
...
void dsp_fir_lattice_f32(
    const dsp_fir_lattice_instance_f32 *S,
    float32_t *pSrc,
    float32_t *pDst,
    uint32_t blockSize)
{
