 ...
 * Title:        dsp_fir_interpolate_init_f32.c
 ...
 * where <code>blockSize</code> is the number of input samples processed by each call to <code>dsp_fir_interpolate_f32()</code>.
 */

dsp_status dsp_fir_interpolate_init_f32(
    dsp_fir_interpolate_instance_f32 *S,
    uint8_t L,
    uint16_t numTaps,
    float32_t *pCoeffs,
    float32_t *pState,
