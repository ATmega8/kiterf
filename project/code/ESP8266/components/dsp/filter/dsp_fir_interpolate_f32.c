 ...
 * Title:        dsp_fir_interpolate_f32.c
 ...
 * <pre>
 * dsp_fir_interpolate_instance_f32 S = {L, phaseLength, pCoeffs, pState};
 * dsp_fir_interpolate_instance_q31 S = {L, phaseLength, pCoeffs, pState};
 * dsp_fir_interpolate_instance_q15 S = {L, phaseLength, pCoeffs, pState};
 * </pre>
...
void dsp_fir_interpolate_f32(
    const dsp_fir_interpolate_instance_f32 *S,
    float32_t *pSrc,
    float32_t *pDst,
    uint32_t blockSize)
{
