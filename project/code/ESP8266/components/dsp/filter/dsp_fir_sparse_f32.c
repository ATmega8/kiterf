 ...
 * <pre>
 *dsp_fir_sparse_instance_f32 S = {numTaps, 0, pState, pCoeffs, maxDelay, pTapDelay};
 *dsp_fir_sparse_instance_q31 S = {numTaps, 0, pState, pCoeffs, maxDelay, pTapDelay};
 *dsp_fir_sparse_instance_q15 S = {numTaps, 0, pState, pCoeffs, maxDelay, pTapDelay};
 *dsp_fir_sparse_instance_q7 S =  {numTaps, 0, pState, pCoeffs, maxDelay, pTapDelay};
 * </pre>
 * \par
 *
...
void dsp_fir_sparse_f32(
    dsp_fir_sparse_instance_f32 *S,
    float32_t *pSrc,
    float32_t *pDst,
    ...
    uint32_t blockSize)
{
    ...
    dsp_circularWrite_f32((int32_t *) py, delaySize, &S->stateIndex, 1,
    ...
    dsp_circularRead_f32((int32_t *) py, delaySize, &readIndex, 1,
