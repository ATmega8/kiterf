 ...
 * <pre>
 *dsp_fir_decimate_instance_f32 S = {M, numTaps, pCoeffs, pState};
 *dsp_fir_decimate_instance_q31 S = {M, numTaps, pCoeffs, pState};
 *dsp_fir_decimate_instance_q15 S = {M, numTaps, pCoeffs, pState};
 * </pre>
...
void dsp_fir_decimate_f32(
    const dsp_fir_decimate_instance_f32 *S,
    float32_t *pSrc,
    float32_t *pDst,
    uint32_t blockSize)
{
