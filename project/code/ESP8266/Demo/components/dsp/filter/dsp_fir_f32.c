...
* <pre>
*dsp_fir_instance_f32 S = {numTaps, pState, pCoeffs};
*dsp_fir_instance_q31 S = {numTaps, pState, pCoeffs};
*dsp_fir_instance_q15 S = {numTaps, pState, pCoeffs};
*dsp_fir_instance_q7 S =  {numTaps, pState, pCoeffs};
* </pre>
*
