 ...
 * Title:        dsp_mat_cmplx_mult_f32.c
 ...
 * <code>dsp_MATH_SIZE_MISMATCH</code> or <code>dsp_MATH_SUCCESS</code> based on the outcome of size checking.
 */

dsp_status dsp_mat_cmplx_mult_f32(
    const dsp_matrix_instance_f32 *pSrcA,
    const dsp_matrix_instance_f32 *pSrcB,
    dsp_matrix_instance_f32 *pDst)
{
    ...
    dsp_status status;                             /* status of matrix multiplication */
