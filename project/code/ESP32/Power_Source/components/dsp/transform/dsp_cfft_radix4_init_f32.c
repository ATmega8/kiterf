 ...
 * Title:        dsp_cfft_radix4_init_f32.c
...
* @deprecated Do not use this function.  It has been superceded by \ref dsp_cfft_f32 and will be removed
* in the future.
...
dsp_status dsp_cfft_radix4_init_f32(
    dsp_cfft_radix4_instance_f32 *S,
    uint16_t fftLen,
    uint8_t ifftFlag,
