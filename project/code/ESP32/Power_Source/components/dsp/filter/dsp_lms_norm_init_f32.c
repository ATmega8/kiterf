...
* where <code>blockSize</code> is the number of input samples processed by each call to <code>dsp_lms_norm_f32()</code>.
*/

void dsp_lms_norm_init_f32(
    dsp_lms_norm_instance_f32 *S,
    uint16_t numTaps,
    float32_t *pCoeffs,
    float32_t *pState,
    float32_t mu,
