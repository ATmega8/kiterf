 ...
 * <pre>
 *    dsp_lms_instance_f32 S = {numTaps, pState, pCoeffs, mu};
 *    dsp_lms_instance_q31 S = {numTaps, pState, pCoeffs, mu, postShift};
 *    dsp_lms_instance_q15 S = {numTaps, pState, pCoeffs, mu, postShift};
 * </pre>
