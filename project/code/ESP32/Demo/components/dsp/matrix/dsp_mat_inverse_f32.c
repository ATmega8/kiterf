 ...
 * <code>dsp_MATH_SIZE_MISMATCH</code> if the input matrix is not square or if the size
 ...
 * <code>dsp_MATH_SINGULAR</code>.  Otherwise, the function returns <code>dsp_MATH_SUCCESS</code>.
 */

dsp_status dsp_mat_inverse_f32(
    ...
    dsp_matrix_instance_f32 *pDst)
{
    ...
    dsp_status status;                             /* status of matrix inverse */
