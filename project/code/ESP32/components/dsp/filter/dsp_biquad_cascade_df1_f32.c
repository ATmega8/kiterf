 ...
 * <pre>
 *     dsp_biquad_casd_df1_inst_f32 S1 = {numStages, pState, pCoeffs};
 *     dsp_biquad_casd_df1_inst_q15 S2 = {numStages, pState, pCoeffs, postShift};
 *     dsp_biquad_casd_df1_inst_q31 S3 = {numStages, pState, pCoeffs, postShift};
 * </pre>
...
void dsp_biquad_cascade_df1_f32(
    const dsp_biquad_casd_df1_inst_f32 *S,
    float32_t *pSrc,
    float32_t *pDst,
    uint32_t blockSize)
{
