 ...
 * Title:        dsp_biquad_cascade_stereo_df2T_f32.c
...
* <pre>
*     dsp_biquad_cascade_df2T_instance_f32 S1 = {numStages, pState, pCoeffs};
* </pre>
...
void dsp_biquad_cascade_stereo_df2T_f32(
    const dsp_biquad_cascade_stereo_df2T_instance_f32 *S,
    float32_t *pSrc,
    float32_t *pDst,
    uint32_t blockSize)
{
